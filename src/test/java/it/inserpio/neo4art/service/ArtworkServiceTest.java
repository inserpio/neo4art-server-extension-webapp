...
public class ArtworkServiceTest
{
  ...
  @Test
  public void shouldGetArtworkByMuseum1051()
  {
    long museumId = 1051;
    
    List<Artwork> artworkList = this.artworkService.findArtworkByMuseum(museumId);
    
    Assert.assertNotNull(artworkList);
    Assert.assertEquals(5, artworkList.size());
